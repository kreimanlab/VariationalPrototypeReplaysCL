...
namebase = 'results/'
namebase1 = '/home/mengmi/Projects/Proj_CL/code/MINSTpermuted/Continual-Learning-Benchmark-master/outputs/permuted_MNIST_incre_domain_VP/'
n_task = 50
n_repeats = 10

## ProtoCLNetFull20R10, ProtoCLNetFull50R10, ProtoCLNetFull50, ProtoCLNetFull20
loadfilenameprefix = 'VP_'
loadfilenamepostfix = '-precision_record.pt'
savefilenameprefix = 'VPNet_'
...
#loadfilenameprefix = 'ProtoCLFCNetFull20T2_'
#loadfilenamepostfix = '-precision_record.pt'
#savefilenameprefix = 'oursFewShot_'
#savefilenamepostfix = '-precision_record.mat'
#
#for i in range(n_repeats):
#    savefilename = os.path.join(namebase1, savefilenameprefix + str(i+1) + savefilenamepostfix)
