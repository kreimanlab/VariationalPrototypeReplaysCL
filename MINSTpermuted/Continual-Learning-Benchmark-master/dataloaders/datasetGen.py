...
from .wrapper import Subclass, AppendName, Permutation, Permutation2
...
def PermutedGen(train_dataset, val_dataset, n_permute, remap_class=False):
    ...
    for i in range(1,n_permute+1):
        ...
        if i==1:  # First task has no permutation
            ...
            train_datasets[name] = AppendName(Permutation2(train_dataset, rand_ind), name, first_class_ind=first_class_ind)
