...
def run(args):
    ...
    if args.offline_training:  # Non-incremental learning / offline_training / measure the upper-bound performance
        ...
        for i in range(len(task_names)):
            ...
            print('======================',train_name,'=======================')
            print('dataset number: ' + str(len(train_dataset_splits[train_name])))
...
def get_args(argv):
    ...
    parser.add_argument('--num_train_sams', type=int, default = 60000, help="The number of training samples")
...
if __name__ == '__main__':
    ...
    for reg_coef in reg_coef_list:
        ...
        for r in range(args.repeat):
            ...
            path = os.path.join('outputs/permuted_MNIST_incre_domain/', '{firstname}_{secondname}-precision_record.pt'.format(firstname=args.agent_name,secondname=(r+1)))
