...
parser.add_argument('--task-number', type=int, default=9)
parser.add_argument('--epochs-per-task', type=int, default=5)
parser.add_argument('--epochs-per-tasknext', type=int, default=5)
...
parser.add_argument('--oriproto-size', type=int, default=10) #only enabled in fcn_storeOriProto #172 is in full; 1633220/(10*32*32*3)
...
parser.add_argument('--dataset-episodes', type=int, default=10) #5000 images per class; thus 5000/dataset_samples
