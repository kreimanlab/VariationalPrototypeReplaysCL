...
def run(args):
    ...
    # Prepare dataloaders
    train_dataset, val_dataset = dataloaders.base.__dict__[args.dataset](args.dataroot, args.num_train_sams, args.train_aug)
...
def get_args(argv):
    ...
    #parser.add_argument('--gpuid', type=int, default=0, help="The list of gpuid, ex:--gpuid 3 1. Negative value means cpu-only")
    ...
    parser.add_argument('--num_train_sams', type=int, default = 100, help="The number of training samples")
...
if __name__ == '__main__':
    ...
    for reg_coef in reg_coef_list:
        ...
        for r in range(args.repeat):
            ...
            path = os.path.join('outputs/split_CIFAR10_incre_class/', '{firstname}_{secondname}-precision_record.pt'.format(firstname=args.agent_name,secondname=(r+1)))
