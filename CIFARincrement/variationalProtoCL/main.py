...
parser.add_argument('--epochs-per-task', type=int, default=100)
parser.add_argument('--epochs-per-tasknext', type=int, default=25)#change to 1 for few shot; 4 in full shots
...
parser.add_argument('--oriproto-size', type=int, default=10) #total number of original images stored for all classes; this number at least equal to number of classes in total
parser.add_argument('--oriproto-eachsize', type=int, default=10) #ori proto size per task (changes across task); full size = 53; fewshot = 10
...
parser.add_argument('--dataset-episodes', type=int, default=1) #leave to default
parser.add_argument('--dataset-nextepisodes', type=int, default=1) #leave to default
parser.add_argument('--dataset-total', type=int, default=10) #total num of images per class
parser.add_argument('--dataset-width', type=int, default=32) #input width/height size #fixed
parser.add_argument('--dataset-nsupport', type=int, default=50) #input support size #fixed
parser.add_argument('--dataset-nquery', type=int, default=50) #input query size #fixed #n_support + n_query must be equal to n_samples
