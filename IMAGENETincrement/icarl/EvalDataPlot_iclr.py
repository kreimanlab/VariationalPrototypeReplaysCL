...
namebase = 'results_iclr/'
namebase1 = '/media/mengmi/DATA/Projects/Proj_CL/code/IMAGENETincrement/Continual-Learning-Benchmark-master/outputs/split_IMAGENET_incremental_class_iclr/'
n_task = 10
n_repeats = 5
